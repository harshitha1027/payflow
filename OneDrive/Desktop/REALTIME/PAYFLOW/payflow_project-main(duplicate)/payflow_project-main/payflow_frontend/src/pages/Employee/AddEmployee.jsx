...
export default function AddEmployee() {
  ...
  const validatePage3 = () => {
    // Position and totalLeaves are required for page 3
  ...
  const pages = [
    ...
    <div>
      ...
      <input name="salary" value={form.salary} onChange={handleChange} style={inputStyle} />
    </div>
      </div>
    </div>,
    ...
    <div>
      ...
      {/* Position and Total Leaves Fields */}
